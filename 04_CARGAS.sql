...
--SELECT * FROM META_VENDAS
 INSERT INTO META_VENDAS VALUES (1,1,'2022','01',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','02',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','03',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','04',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','05',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','05',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','07',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','08',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','09',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','10',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','11',83.33);
 INSERT INTO META_VENDAS VALUES (1,1,'2022','12',83.33);

 INSERT INTO META_VENDAS VALUES (1,2,'2022','01',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','02',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','03',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','04',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','05',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','07',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','08',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','09',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','10',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','11',83.33);
 INSERT INTO META_VENDAS VALUES (1,2,'2022','12',83.33);
...
--DELETE FROM PED_VENDAS
 ...
 (1,1,1,'13/01/2022','29/01/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,3,'13/02/2022','28/02/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,2,'13/03/2022','29/03/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,2,'13/04/2022','29/04/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,3,'13/05/2022','29/05/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,1,3,'13/06/2022','29/06/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,1,'13/07/2022','29/07/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,3,'13/08/2022','29/08/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,2,'13/09/2022','29/09/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,1,'13/10/2022','29/10/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,1,2,'13/11/2022','29/11/2022','A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,2,'13/12/2022','29/12/2022','A');
...
--SELECT * FROM PARAM_INSS
   INSERT INTO PARAM_INSS VALUES ('01/01/2022','31/12/2022',0,1659.38,8);
   INSERT INTO PARAM_INSS VALUES ('01/01/2022','31/12/2022',1659.39,2765.66,9);
   INSERT INTO PARAM_INSS VALUES ('01/01/2022','31/12/2022',2765.67,5531.31,11);
   INSERT INTO PARAM_INSS VALUES ('01/01/2022','31/12/2022',5531.32,999999,0);

--CARGA PARAMETROS IRPF

--DELETE FROM PARAM_IRRF
 INSERT INTO PARAM_IRRF VALUES ('01/01/2022','31/12/2022',0,1903.98,0,0);
 INSERT INTO PARAM_IRRF VALUES ('01/01/2022','31/12/2022',1903.99,2826.65,7.5,142.80);
 INSERT INTO PARAM_IRRF VALUES ('01/01/2022','31/12/2022',2826.66,3751.05,15,354.80);
 INSERT INTO PARAM_IRRF VALUES ('01/01/2022','31/12/2022',3751.06,4664.68,22.5,636.13);
 INSERT INTO PARAM_IRRF VALUES ('01/01/2022','31/12/2022',4664.68,999999,27.5,869.36);
